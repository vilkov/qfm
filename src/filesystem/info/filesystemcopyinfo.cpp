...
bool CopyInfo::isPhysical() const
{
	return m_info.isPhysical();
}
...
void CopyInfo::rawCopy(const IFileInfo *source, QString &error) const
{
	return m_info.rawCopy(source, error);
}
