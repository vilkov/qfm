...
{
public:
	UpdateProgressEvent(const TaskNodeItem *item, quint64 progress, quint64 timeElapsed) :
...
{
public:
	CompletedProgressEvent(const TaskNodeItem *item, quint64 timeElapsed) :
