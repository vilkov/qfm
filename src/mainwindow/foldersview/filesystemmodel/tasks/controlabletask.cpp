	...
	m_params(parameters)
{
	...
	m_handlers[0] = m_verificationHandlers[0] = new DeleteHandler(0, this, controller1);
}
	...
	m_params(parameters)
{
	...
	memset(&m_handlers, 0, sizeof(DeleteHandler *) * MaxNumberOfControllers);
	m_handlers[0] = m_verificationHandlers[0] = new DeleteHandler(0, this, controller1);
	m_handlers[1] = m_verificationHandlers[1] = new DeleteHandler(1, this, controller2);
}
	...
	m_params(parameters)
{
	...
	m_handlers[0] = m_verificationHandlers[0] = new DeleteHandler(0, this, controller1);
	m_handlers[1] = m_verificationHandlers[1] = new DeleteHandler(1, this, controller2);
	m_handlers[2] = m_verificationHandlers[2] = new DeleteHandler(2, this, controller3);
}
