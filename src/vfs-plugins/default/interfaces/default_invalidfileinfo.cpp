 ...
 */
#include "default_invalidfileinfo.h"
...
InvalidInfo::InvalidInfo(const QString &fileName) :
	m_fileName(location(fileName, ::Desktop::Locale::current()->codec()->fromUnicode(fileName))),
	m_icon(::Desktop::Theme::current()->missingIcon())
{}

InvalidInfo::InvalidInfo(const QByteArray &fileName) :
    m_fileName(location(::Desktop::Locale::current()->codec()->toUnicode(fileName), fileName)),
    m_icon(::Desktop::Theme::current()->missingIcon())
{}
