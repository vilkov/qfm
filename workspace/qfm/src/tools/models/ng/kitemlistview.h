 ...
 * @see KItemModelBase
 */
class KItemListView : public QGraphicsWidget
{
    Q_OBJECT
 ...
 */
class KItemListWidgetCreatorBase : public KItemListCreatorBase
{
public:
 ...
 */
class KItemListGroupHeaderCreatorBase : public KItemListCreatorBase
{
public:
