...
CompositeValueDialog::CompositeValueDialog(const IdmContainer &container, const EntityValue &value, QWidget *parent) :
...
CompositeValueDialog::CompositeValueDialog(const IdmContainer &container, const EntityValue &value, const CompositeValueModel::Files &files, QWidget *parent) :
    NestedPlainDialog(parent),
    m_handler(this),
