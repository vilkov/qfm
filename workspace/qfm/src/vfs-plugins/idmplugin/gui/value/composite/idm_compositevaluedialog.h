...
public:
    CompositeValueDialog(const IdmContainer &container, const EntityValue &value, QWidget *parent = 0);
    CompositeValueDialog(const IdmContainer &container, const EntityValue &value, const CompositeValueModel::Files &files, QWidget *parent = 0);
