...
{
public:
    QueryResultsNode(const IdmContainer &container, const EntityValueReader &reader, Node *parent = 0);
...
protected:
    ...
    virtual void add(const QModelIndex &index, const EntityValue::List &values);
    virtual void remove(const QModelIndex &index, const EntityValue::List &values);
